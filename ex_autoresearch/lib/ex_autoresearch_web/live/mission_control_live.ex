defmodule ExAutoresearchWeb.MissionControlLive do
  ...
  def render(assigns) do
    ...
    >
      <div
        id="mission-shell"
        class="relative w-full overflow-hidden rounded-2xl border border-base-300 bg-[#05070d] shadow-xl"
        ...
        <div class="pointer-events-none absolute top-4 left-4 z-10 flex flex-col gap-2">
          ...
          <div class="rounded-lg border border-white/10 bg-black/50 backdrop-blur-md px-4 py-3 text-white shadow-lg w-72">
            ...
            <div class="mt-1 text-xs text-white/70">
              <span data-mc-sat-count class="text-base font-semibold text-white tabular-nums">0</span>
        ...
        <%= if @focused do %>
          ...
          >
            <div class="sticky top-0 z-10 flex items-center justify-between border-b border-white/10 bg-black/70 px-4 py-3">
              <div class="min-w-0">
                <div class="text-[10px] uppercase tracking-[0.2em] text-white/40">Investigation</div>
              ...
              <%= if inv = @focused.investigation do %>
                ...
                <div class="grid grid-cols-2 gap-3">
                  <%= if inv.quality_score do %>
                    <div>
                      <div class="text-[10px] uppercase tracking-[0.2em] text-white/40">Quality</div>
                  ...
                  <%= if (inv.content_length || 0) > 0 do %>
                    <div>
                      <div class="text-[10px] uppercase tracking-[0.2em] text-white/40">Content</div>
                      <div class="mt-1 font-mono tabular-nums text-white/90">
                  ...
                  <%= if inv.fetched_at do %>
                    <div class="col-span-2">
                      <div class="text-[10px] uppercase tracking-[0.2em] text-white/40">Fetched</div>
