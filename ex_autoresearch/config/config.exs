...
config :ex_autoresearch, ExAutoresearchWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ExAutoresearchWeb.ErrorHTML, json: ExAutoresearchWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: ExAutoresearch.PubSub,
  live_view: [signing_salt: "UXBtf+K9"]
...
config :ex_autoresearch, ExAutoresearch.Mailer, adapter: Swoosh.Adapters.Local
